  ...
  return (
    <div className="space-y-4">
      {messages.map((message) => {
        ...
        const isEditing = editingMessageId === message.messages_id;
        const isUpdating = updatingMessageId === message.messages_id;
        ...
        return (
          ...
          >
            <div 
              ...
              onMouseEnter={() => !isEditing && setHoveredMessageId(message.messages_id)}
            ...
            >
                ...
                {isEditing ? (
                  <div className="space-y-2">
                    <input
                      ...
                      onKeyDown={(e) => handleKeyPress(e, message.messages_id)}
                    ...
                    <div className="flex justify-end gap-2">
                      <button
                        onClick={() => handleUpdateMessage(message.messages_id)}
              ...
              <div className={`flex flex-col gap-1 transition-all duration-300 ease-in-out ${
                ...
                {canEdit && (
                  <button
                    onClick={() => handleStartEdit(message.messages_id, message.content)}
